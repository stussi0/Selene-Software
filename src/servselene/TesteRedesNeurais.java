 ...
 */
public class TesteRedesNeurais {
    public static void main(String arg[]){
        ...
        if(criar){
            ...
            try {
                ...
                Logger.getLogger(TesteRedesNeurais.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            try {
        ...
        try {
            ...
            while(Integer.valueOf(JOptionPane.showInputDialog("0-sair\n1-classificar"))==1){
                ...
                if(Math.random()>0.5){
                    dd2[2] = db.attribute(2).indexOfValue("masculino");
                } else {
                    dd2[2] = db.attribute(2).indexOfValue("feminino");
                }
